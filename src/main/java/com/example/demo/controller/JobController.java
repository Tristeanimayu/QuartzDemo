...
public class JobController {
    ...
    public Result save() {
        ...
        try {
            ...
            Date endDate = endCal.getTime();// 任务结束日期为2021年9月12日12点30分
            ...
            String jobName = "testJobId" + timesStamp.timesStamp();
            String triggerName = "tesTriggerNmae" + timesStamp.timesStamp();
            quartzJobModule.setJobName(jobName);
            quartzJobModule.setTriggerName(triggerName);
...
//                    endDate, weeks.split(","));
    ...
    public Result pause(String jobName, String jobGroup) {
        LOGGER.info("暂停任务");
        quartzJobComponent.pauseJob("testJobId0");
        return Result.ok();
    }
    ...
    public Result resume(String jobName, String jobGroup) {
        LOGGER.info("恢复任务");
        quartzJobComponent.resumeJob("testJobId0");
        return Result.ok();
    ...
    public Result remove(String jobName, String jobGroup) {
        LOGGER.info("移除任务");
        quartzJobComponent.removeJob("testJobId0");
        return Result.ok();
    }
}
